...
if __name__ == "__main__":
    ...
    while cap.isOpened():
        ...
        cycle_count, finger_count, phase, warning, progress = exercise.track_breathing_exercise(frame)
        ...
        cv2.rectangle(frame, (10, 120), (210, 140), (255, 255, 255), 2)
        
        cv2.imshow('Breathing Exercise', frame)
