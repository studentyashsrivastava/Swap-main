...
try:
    ...
    from exercises.chair_yoga import ChairYoga
    from exercises.breathing_exercise import BreathingExercise
    ...
    while True:
        ...
        if exercise_running and current_exercise:
            ...
            if results.pose_landmarks:
                ...
                elif current_exercise_data['type'] == "chair_yoga":
                    (counter_right, angle_right, counter_left, angle_left,
                     warning_message_right, warning_message_left, progress_right, 
                     progress_left, stage_right, stage_left) = current_exercise.track_chair_yoga(
                        results.pose_landmarks.landmark, frame)
                    layout_indicators(frame, current_exercise_data['type'], 
                                     (counter_right, angle_right, counter_left, angle_left,
                                      warning_message_right, warning_message_left, 
                ...
                elif current_exercise_data['type'] == "breathing_exercise":
                    cycle_count, finger_count, phase, warning_message, progress = current_exercise.track_breathing_exercise(frame)
                    layout_indicators(frame, current_exercise_data['type'], 
                                     (cycle_count, finger_count, phase, warning_message, progress))
                    exercise_counter = cycle_count
                ...
                if exercise_counter >= exercise_goal:
                    ...
                    elif current_exercise_data['type'] == "hammer_curl" or current_exercise_data['type'] == "chair_yoga":
                        current_exercise.counter_right = 0
                        current_exercise.counter_left = 0
                    elif current_exercise_data['type'] == "breathing_exercise":
                        current_exercise.cycle_count = 0
...
def start_exercise():
    ...
    if exercise_type == "squat":
        ...
        current_exercise = ChairYoga()
    elif exercise_type == "breathing_exercise":
        current_exercise = BreathingExercise()
    else:
