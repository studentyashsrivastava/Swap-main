...
# Range-of-Motion: Tracks shoulder joint motion (arm raise) within comfort limits
class RangeOfMotion:
    def __init__(self):
        self.counter = 0
        self.stage = "Initial"
...
if __name__ == "__main__":
    ...
    print("Perform gentle arm raises within a comfortable range. Press 'q' to quit.")
